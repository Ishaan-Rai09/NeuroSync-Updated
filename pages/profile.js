      ...
      <Layout>
        <div className="flex justify-center items-center h-screen">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-gray-700 dark:text-gray-300">Loading user profile...</h2>
            <p className="mt-2 text-gray-600 dark:text-gray-400">Please wait or <Link href="/login" className="text-primary hover:underline">login</Link> if you haven't already.</p>
          </div>
        </div>
      </Layout>
    );
